...
<div>
	<span class="breadcrumbs">Home > Job Management > Daily
		Appointments </span>
</div>
			...
			function() {
				...
				$("#searchButton").click(
						function() {
							if (validSelection()) {
								$('#reportForm').attr('action',
										'dailyAppointmentsReportList.html');
								$('#reportForm').submit();
							}
						});
			...
			<table width="100%" class="searchFiltersTable">
				...
				<tr>
					<td colspan="1" align="left" width="20%"><input type="hidden"
						...
						style="font-size: 13px; font-family: Verdana;">Start Date</span>
						<div id="startDateDiv"></div></td>
					<td colspan="1" width="20%" align="left" nowrap><span
						style="font-size: 13px; font-family: Verdana;">End Date</span>
						<div id="endDateDiv"></div></td>
