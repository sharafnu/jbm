	...
	$(document)
			.ready(
					function() {
						...
						var employeeStatusSource = [ "Active", "In-Active",
								"Resigned" ];

						$("#formEmployeeStatus").jqxComboBox({
							selectedIndex : 0,
							source : employeeStatusSource,
							width : 100,
							height : 20
						});
						...
						var staffListDataAdapter = new $.jqx.dataAdapter(
								staffListSource);
