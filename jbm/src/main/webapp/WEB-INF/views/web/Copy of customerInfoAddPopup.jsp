...
$(document).ready(function() {
	...
	$('#addCustomerPopupWindow').jqxWindow({
        showCollapseButton: false, maxHeight: 820, maxWidth: 1100, minHeight: 820, minWidth: 1100, height: 820, width: 1100,
        autoOpen: false,
	...
	/* var mapOptions = {
		       ...
		       center: new google.maps.LatLng(25.2,55.3)
		     };
		  ...
		  var defaultBounds = new google.maps.LatLngBounds(
			      new google.maps.LatLng(25.2,55.3),
			      new google.maps.LatLng(25.2,55.3));
		        	...
		        	<td colspan="2">
		        		<div>
		        			<!-- <div align="left">
						  	...
						  	<div align="left" id="map" style="width:1000px; height: 500px; margin-top: 10px;">
						   	</div>  -->
