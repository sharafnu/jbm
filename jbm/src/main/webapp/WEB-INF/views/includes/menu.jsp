                ...
                <ul>
                    ...
                    <li>Customer
                        <ul style='width: 250px;'>
                            <li><a href="#Education">Add Customer Info</a></li>
                            <li><a href="#Financial">Edit Customer Info</a></li>
                            <li><a href="#Government">Customer Contracts</a></li>
                            <li type='separator'></li>
                            <li>Master Setup
                                <ul style='width: 220px;'>
                                    <li><a href="#ConsumerPhoto">Staff Details</a></li>
                                    <li><a href="#Mobile">Area List</a></li>
